...
class NeighborhoodsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create neighborhood" do
    assert_difference('Neighborhood.count') do
      post neighborhoods_url, params: { neighborhood: { city: @neighborhood.city, name: @neighborhood.name, state: @neighborhood.state } }
    end
  ...
  test "should update neighborhood" do
    patch neighborhood_url(@neighborhood), params: { neighborhood: { city: @neighborhood.city, name: @neighborhood.name, state: @neighborhood.state } }
