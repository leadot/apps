...
class IncidentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create incident" do
    assert_difference('Incident.count') do
      post incidents_url, params: { incident: { date: @incident.date, description: @incident.description, neighborhood_id: @incident.neighborhood_id } }
    end
  ...
  test "should update incident" do
    patch incident_url(@incident), params: { incident: { date: @incident.date, description: @incident.description, neighborhood_id: @incident.neighborhood_id } }
